...
/*
 * NOTE:
 * The vendor init table for SPD2010 is very long and hardware-specific.
 * This copy is intentionally kept in repo so the board can be built without
 * an out-of-tree dependency on the Waveshare demo folder.
 */
